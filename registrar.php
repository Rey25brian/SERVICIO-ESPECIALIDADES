   ...
   <form class="formulario redondear-tarjeta" style="margin-top: 5%;" action="<?= base_url(); ?>registrar-usuario" method="post">
     <h1>Regístrate</h1>
     <div class="contenedor">
       ...
       <p class="link-n">
         ¿Eres medico?<a class="link" href="<?= base_url(); ?>registroM">Regístrate</a>
       </p>
     </div>
   </form>
