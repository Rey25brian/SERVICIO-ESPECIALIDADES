        ...
        <div class="row">
            ...
            <div class="redondear-tarjeta">
                ...
                <div class="section-title position-relative mb-4">
                    ...
                    <h1 class="display-4">Información generar especialidades</h1>
                </div>
                <center>
                ...
                <div class="row pt-3">
                    <div class="table-responsive">
                        <?php if ($reservas == null) { ?>
                            <h1 class="display-5">Sin especialidades</h1>.
                        <?php } else { ?>
                                ...
                                <tbody>
                                    <?php foreach ($reservas as $item) { ?>
                                        <tr class="">
                                            ...
                                            <td>
                                                <div><a name="" id="boton" class="btn btn-info" href="<?= base_url(); ?>comprobante/<?= $item['id_especialidad'] ?>" role="button">Modificar</a><a name="" id="boton" class="btn btn-danger" href="<?= base_url(); ?>eliminarServicio/<?= $item['id_especialidad'] ?>" role="button">Eliminar</a></div>
                                            </td>
                                        </tr>
                                    <?php }  ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="<?= base_url(); ?>agregarServicio" method="POST">
