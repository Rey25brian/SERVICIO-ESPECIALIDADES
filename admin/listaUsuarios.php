            ...
            <div class="row">
                ...
                <div class="redondear-tarjeta">
                    <div class="section-title position-relative mb-4">
                        ...
                        <h1 class="display-4">Información generar de usuarios</h1>
                    </div>

                    <div class="row pt-3">
                        <div class="table-responsive">
                            <?php if ($reservas == null) { ?>
                                <h1 class="display-5">Sin usuarios</h1>.
                            <?php } else { ?>
                                    ...
                                    <tbody>
                                        <?php foreach ($reservas as $item) { ?>
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div><a name="" id="boton" class="btn btn-info" href="<?= base_url(); ?>comprobante/<?= $item['id_Usuarios'] ?>" role="button">Comprobante</a>
                                                    <a name="" id="boton" class="btn btn-info" href="<?= base_url(); ?>comprobante/<?= $item['id_Usuarios'] ?>" role="button">Comprobante</a></div>
                                                </td>
                                            </tr>
                                        <?php }  ?>
